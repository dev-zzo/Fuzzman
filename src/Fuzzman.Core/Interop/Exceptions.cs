...
namespace Fuzzman.Core.Interop
{
    public enum EXCEPTION_CODE : uint
    {
        ...
        EXCEPTION_ENTRYPOINT_NOT_FOUND = NTSTATUS.STATUS_ENTRYPOINT_NOT_FOUND,

        EXCEPTION_CPLUSPLUS = 0xE06D7363, // MSVC C++ exception code
        EXCEPTION_DELPHI = 0x0EEDFADE, // Delphi exception code (unofficial?)
    }
